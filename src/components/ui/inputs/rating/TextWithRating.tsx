...
export const TextWithRating: React.FC<TextWithRatingProps> = ({
  ...
  const ratingText = `${displayValue} out of ${max} star${displayValue !== 1 ? 's' : ''}`;
  ...
  return (
    <div className={`${getContainerClasses()} ${className}`}>
      ...
      {textPosition === 'bottom' && <TextComponent />}
    </div>
  );
}; 