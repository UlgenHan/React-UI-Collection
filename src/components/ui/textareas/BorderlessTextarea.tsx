...
interface BorderlessTextareaProps {
  ...
  backgroundColor?: 'transparent' | 'gray' | 'white';
}
...
export default function BorderlessTextarea({
  ...
  const textareaId = id || `borderless-textarea-${Math.random().toString(36).substr(2, 9)}`;
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <textarea
        ...
        rows={rows}
        className={`
          w-full px-3 py-2 border-0 text-gray-900 placeholder-gray-400 rounded-md
