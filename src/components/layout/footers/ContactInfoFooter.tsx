...
export interface ContactInfoFooterProps {
...
const ContactInfoFooter: React.FC<ContactInfoFooterProps> = ({
  contactDetails,
  ...
  const contact = contactDetails || defaultContactDetails;
                  ...
                  <div>
                    ...
                    {contact.mapLink && (
                      <a
                        ...
                        className="inline-flex items-center mt-2 text-sm text-blue-600 hover:text-blue-800 transition-colors duration-200"
                      >
                        View on Map
              ...
              {contact.phone && (
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    {contact.fax && (
                      <p className="text-sm text-gray-500 mt-1">Fax: {contact.fax}</p>
                    )}
                  </div>
                </div>
              )}
              ...
              {contact.businessHours && (
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">{contact.businessHours}</p>
                  </div>
                </div>
              )}
            </div>
