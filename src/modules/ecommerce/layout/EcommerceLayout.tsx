...
const EcommerceLayout: React.FC = () => {
  ...
  const navigationItems = [
    { name: 'Dashboard', path: '/ecommerce/dashboard', icon: '📊' },
    { name: 'Products', path: '/ecommerce/products', icon: '🛍️' },
    { name: 'Cart', path: '/ecommerce/cart', icon: '🛒', badge: cartItemCount },
    { name: 'Orders', path: '/ecommerce/orders', icon: '📦' },
    { name: 'Admin', path: '/ecommerce/admin', icon: '⚙️' },
  ];
